...
{
    public List<ContentPage> lehed = new List<ContentPage>() { new PickerImagePage(), new PopUp_Page(), new TripsTrapsTrullPage()};
    public List<string> tekstid = new List<string> { "Tee lahti PickerImagePage", "Tee lahti PopUp_Page", "Tee lahti TripsTrapsTrullPage" };
